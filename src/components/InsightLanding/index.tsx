...
const InsightLanding: FC = () => {
    return (
        <MainContainer>
            <Container>
                <PaidIcon fontSize='large' style={{ marginTop: '1rem', color: '#7E1B75' }} />
                <TitleInsight>
                    Financial projects</TitleInsight>
                <DataContainer>40.505</DataContainer>
            </Container>
            <Container>
                <GroupWorkIcon fontSize='large' style={{ marginTop: '1rem', color: '#7E1B75' }} />
                <TitleInsight>Project success ratio</TitleInsight>
                <DataContainer>90%</DataContainer>
            </Container>
            <Container>
                <GroupsIcon fontSize='large' style={{ marginTop: '1rem', color: '#7E1B75' }} />

        ...
        <MainContainerButtonSimulation>
            ...
            {showDiv && <MainContainer>
                ...
                <TitleSimulationContainer>
                    <TitleSimulation>Simulate your invest</TitleSimulation>
                </TitleSimulationContainer>

                <MainContainerSimulation>
                    <CurrencySimulationContainer>
                        <InputLabelStyled style={{ color: 'black' }} >Currency:</InputLabelStyled>
                        <Select style={{ marginLeft: "20px" }} value={moneda} onChange={handleMonedaChange}>
                    ...
                    <LabelSimulationContainer>
                        <LabelSimulation htmlFor="cantidad-inversion">Amount Invest:</LabelSimulation>
                        <TextField
                            type="number"
                        ...
                        />
                        <div style={{ fontFamily: 'Roboto', color: '#7E1B75' }}>
                            {moneda}
                        </div>
                    </LabelSimulationContainer>
                ...
                <TotalActions>
                    <LabelSimulation htmlFor="cantidad-acciones">Total Stocks:</LabelSimulation>
                    <SpanTotal id="cantidad-acciones">{cantidadAcciones}{' '}Stocks x{' '}{cantidadInversion}{' '}{moneda}</SpanTotal>
                </TotalActions>
            </MainContainer>}
        </MainContainerButtonSimulation>
    );
